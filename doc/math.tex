...
Because the polynomials/projected cosines are \textit{asymmetrical}, we can natually use this basis to model arbitrary, lopsided functions without having to worry about phase shifts \hyperref[phase]{like we did for the Fourier basis}.
