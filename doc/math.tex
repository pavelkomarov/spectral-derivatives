...
\[\label{halfindex}
y_{n,\text{II}} = \frac{1}{M} \Big(\underbrace{Y_0}_{Y_{0,\text{II}}} + 2 \sum_{k = 1}^N \underbrace{Y_k \underbrace{e^{-j \frac{2\pi}{M}k\frac{1}{2}}}_{\text{phase ramp}}}_{Y_{k,\text{II}}} \cos\!\big(\underbrace{\frac{\pi k}{N+1} (n + \frac{1}{2})}_{=\theta_{n,\text{II}}}\big) \Big) \tag{DCT-II$^{-1}$}
\]
