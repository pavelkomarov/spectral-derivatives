...
\section{Chebyshev Derivatives via Fourier}\label{algo}

This all suggests a solution procedure:

\begin{algorithm}
\caption*{\textbf{Chebyshev Derivative via Fourier Derivative}}
...
TODO, mostly rip in the scicomp post
